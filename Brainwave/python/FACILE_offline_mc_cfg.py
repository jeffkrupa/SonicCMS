...
options.register("threads", 0, VarParsing.multiplicity.singleton, VarParsing.varType.int)
options.register("streams", 0,    VarParsing.multiplicity.singleton, VarParsing.varType.int)
options.register("batchsize", 160000,    VarParsing.multiplicity.singleton, VarParsing.varType.int)
...
################### EDProducer ##############################
process.HcalProducer = cms.EDProducer('HcalPhase1Reconstructor_FACILELocal',
...
keep_msgs = ['TRTClient','HcalProducer','TFClientLocal']
