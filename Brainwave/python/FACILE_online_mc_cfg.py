...
options.register("inputfile", "file:out_skim.root", VarParsing.multiplicity.singleton, VarParsing.varType.string)
...
options.register("batchsize", 4500,    VarParsing.multiplicity.singleton, VarParsing.varType.int)
...
if options.mode != "Sync" and not options.remote:
    raise ValueError("Local TF operation is strictly synchronous.")
...
sys.path.insert(0,os.path.expandvars("$CMSSW_BASE/src/HLTrigger/Configuration/test"))
from OnLine_HLT_GRun import process
process.hltHbhePhase1Reco = cms.EDProducer('HcalPhase1Reconstructor_FACILELocal',
    ...
    Client = cms.PSet(
        ...
        classifier = cms.string("facile.pb")
    )
)
print(process)
'''
...
_customInfo['globalTags'][False] = "auto:phase1_2021_realistic" #"auto:phase1_2021_realistic"#106X_upgrade2021_realistic_v5"
_customInfo['inputFiles']={}
_customInfo['inputFiles'][True]  = "file:default.root"
_customInfo['inputFiles'][False]= [options.inputfile]*60
_customInfo['maxEvents' ]=  options.maxEvents
_customInfo['reportEvery' ]=  10
_customInfo['globalTag' ]= "auto:phase1_2021_realistic"# 106X_upgrade2021_realistic_v5 106X_mc2017_realistic_v3"
_customInfo['inputFile' ]= [options.inputfile]*60
