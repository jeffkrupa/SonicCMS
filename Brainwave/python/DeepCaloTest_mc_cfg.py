...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('file:../../Core/data/store_mc_RunIISpring18MiniAOD_BulkGravTohhTohbbhbb_narrow_M-2000_13TeV-madgraph_MINIAODSIM_100X_upgrade2018_realistic_v10-v1_30000_24A0230C-B530-E811-ADE3-14187741120B.root')
    	fileNames = cms.untracked.vstring(['file:out_hcalonly_skim.root']*100),
...
################### EDProducer ##############################
process.DeepCaloProducer = cms.EDProducer('DeepCaloProducerLocal',#allowed_modes[options.mode],
    topN = cms.uint32(5),
    #binDataPath = cms.string("../../Core/data/image0_1000.bin"),
    binDataPath = cms.string("deepcalo_all.bin"),
    Client = cms.PSet(
        #ninput  = cms.uint32(2464),
        #noutput = cms.uint32(1),
        #batchSize = cms.uint32(5),#options.batchsize),
	...
	classifier = cms.string("electron_model.pb"),
    )
)
...
keep_msgs = ['TFClientLocal','DeepCaloProducer']
